-- ============================================================================
-- Table: workspace.semantic.sem_job_role_map
-- Layer: SEMANTIC
-- Description: Job title to canonical role mapping for role standardization
-- ============================================================================
-- Purpose: Physical table definition for sem_job_role_map
...
CREATE TABLE IF NOT EXISTS workspace.semantic.sem_job_role_map (
