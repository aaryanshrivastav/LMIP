-- ============================================================================
-- Table: workspace.semantic.sem_company_canonical
-- Layer: SEMANTIC
-- Description: Canonical company name mapping. Links company name variations to canonical names.
-- ============================================================================
-- Purpose: Physical table definition for sem_company_canonical
...
CREATE TABLE IF NOT EXISTS workspace.semantic.sem_company_canonical (
