-- ============================================================================
-- Table: workspace.semantic.sem_skill_catalog
-- Layer: SEMANTIC
-- Description: Canonical skill catalog with taxonomy and metadata
-- ============================================================================
-- Purpose: Physical table definition for sem_skill_catalog
...
CREATE TABLE IF NOT EXISTS workspace.semantic.sem_skill_catalog (
